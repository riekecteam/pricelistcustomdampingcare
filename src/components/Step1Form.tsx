        ...
        {data.logo ? (
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <div className="rounded-2xl bg-lavender-50 border border-[#F2E8F8] flex items-center justify-center overflow-hidden shrink-0" style={{ width: Math.min(120, data.logoSize), height: Math.min(120, data.logoSize) }}>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-sm font-medium text-text-primary">Ukuran Logo</label>
                <div className="flex items-center gap-1.5">
                  <input
                    ...
                    onChange={e => {
                      ...
                      if (!isNaN(v)) update({ logoSize: Math.min(200, Math.max(40, v)) });
                    }}
                  ...
                  />
                  <span className="text-xs text-text-secondary font-medium w-6">px</span>
                </div>
              </div>
              <input type="range" min={40} max={200} step={5} value={data.logoSize} onChange={e => update({ logoSize: +e.target.value })} className="w-full" />
              <div className="flex justify-between mt-1">
                <span className="text-[10px] text-text-secondary/60">40px</span>
                <span className="text-[10px] text-text-secondary/60">200px</span>
              </div>
            </div>
          </div>
        ) : (
